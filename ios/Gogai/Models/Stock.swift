...
struct Stock: Identifiable, Codable, Hashable, Sendable {
    ...
    func updating(title: String? = nil, categoryId: Int? = nil, categoryName: String? = nil, summary: FieldUpdate<String> = .keep, hasTranslation: Bool? = nil) -> Stock {
        Stock(id: id, url: url,
              title: title ?? self.title,
              source: source,
              category_id: categoryId ?? category_id,
              category_name: categoryName ?? category_name,
              summary: summary.apply(to: self.summary),
