...
struct ArticleRepository: Sendable {
    ...
    func fetchAll(feedId: Int? = nil, groupId: Int? = nil, unreadOnly: Bool = false, sortOrder: ArticleSortOrder = .publishedAt, limit: Int = 100, offset: Int = 0, includeSecret: Bool = false) async throws -> [Article] {
